...
<body>
  ...
  <div class="login-container">
    ...
    <c:if test="${empty requestScope.User}">
      <form action="${fn:escapeXml(pageContext.servletContext.contextPath)}/admin-signin" method="post" class="login-form">
        
        <div class="form-group">
          <label for="id" class="form-label">ログインID</label>
          <input type="text" id="id" name="id" class="form-control" value="${fn:escapeXml(requestScope.lastInputId)}">
        </div>
        ...
        <div class="new-user">
          <a href="${fn:escapeXml(pageContext.servletContext.getContextPath())}/admin-signup">新規登録</a>
        </div>
