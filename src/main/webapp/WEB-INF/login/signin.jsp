...
<body>
  ...
  <div class="login-container">
    ...
    <c:if test="${empty requestScope.User}">
      <form action="${fn:escapeXml(pageContext.servletContext.contextPath)}/signin" method="post" class="login-form">
        ...
        <div class="new-user">
          <a href="${fn:escapeXml(pageContext.servletContext.getContextPath())}/signup">新規登録</a>
        </div>
