...
<body>
    ...
    <div class="signup-container">
        ...
        <h1 class="signup-title">管理者新規登録</h1>
        ...
        <c:if test="${not empty requestScope.success}">
            ...
            <div class="form-footer-link">
                <a href="${pageContext.request.contextPath}/admin">ログインページへ</a>
            </div>
        </c:if>

        <%-- 新規登録フォーム --%>
        <c:if test="${empty requestScope.success}">
            <form action="${pageContext.request.contextPath}/admin-signup" method="post" class="login-form">
                ...
                <%-- ▼▼▼ここから追加▼▼▼ --%>
                <div class="form-group">
                    <label for="security_code" class="form-label">セキュリティコード</label>
                    <input type="text" id="security_code" name="security_code" class="form-control" required>
                    <small class="form-text">指定されたセキュリティコードを入力してください。</small>
                </div>
                <%-- ▲▲▲ここまで追加▲▲▲ --%>
