...
public class AdminSignin {
   ...
   */
  public AdminSigninResult execute(String userName, String password) throws Failure {
    ...
    try {
      ...
      AdminSigninResult result = new AdminSigninResult(user, Optional.ofNullable(activeReservation));
      return result;
