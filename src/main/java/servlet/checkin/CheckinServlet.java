...
@WebServlet("/checkin-reserved")
public class CheckinServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
            throws ServletException, IOException {
        request.getRequestDispatcher("/WEB-INF/checkin/checkin-reserved.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (qrData != null && !qrData.isEmpty()) {
            ...
            request.getRequestDispatcher("/WEB-INF/checkin/checkin-result.jsp").forward(request, response);
            return;
        }
